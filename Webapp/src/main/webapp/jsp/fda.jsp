...
<body>
	...
	<div id="getGuns" class="" style="">
		<div class="table-wrapper-scroll-y my-custom-scrollbar" id='tabDiv'>
			<h2 id="appDD">Drugs For FDA Approval</h2>
			<button class="btn btn-lg btn-info btn-block" id="fdaBtn"
				type="button" onclick="getDrugs();">Get Drug Info</button>
